...
class DQNfDAgent(DQNAgent):
    ...
    def __init__(self,
        ...
        DQNAgent.__init__(self, env, cfg)

        self.learner = DQNLearner(env, cfg, self.observation_space, self.action_space)
    ...
    def pretrain(self):
        ...
        for i_step in range(1, pretrain_step + 1):
            ...
            #TODO: Offline logging (check ddpgfd)
            # logging
