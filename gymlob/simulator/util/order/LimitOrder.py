...
class LimitOrder(Order):
    ...
    def __init__(self, agent_id, time_placed, symbol, quantity, is_buy_order, limit_price, order_id=None, tag=None):
        ...
        # The limit price is the minimum price the agents will accept (for a sell order) or
        # the maximum price the agents will pay (for a buy order).
    ...
    def __str__(self):
        ...
        return "(Agent {} @ {}{}) : {} {} {} @ {}{}".format(self.agent_id, fmtTime(self.time_placed),
    ...
    def __copy__(self):
        order = LimitOrder(self.agent_id, self.time_placed, self.symbol, self.quantity, self.is_buy_order,
                           ...
                           tag=self.tag)
        Order._order_ids.pop()  # remove duplicate agents ID
